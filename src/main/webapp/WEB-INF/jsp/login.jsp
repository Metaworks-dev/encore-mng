...
<body>
<div class="login-title"><h2>EN-CORE</h2></div>
<div class="container">
    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <form id="login-form" action="${pageContext.request.contextPath}/loginProc" method="post" role="form" style="display: block;">
                                ...
                                <div class="form-group">
                                    <input type="text" name="USERID" id="userid" tabindex="1" class="form-control" placeholder="Username" value="exospace" required autofocus>
                                </div>
                                <div class="form-group">
...
<div class="modal fade" id="licenseExpired" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                License Expired.<br></a> You must reissue the license key.
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">OK</button>
            </div>
